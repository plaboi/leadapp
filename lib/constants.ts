//timers 
export const FOLLOWUP_DELAY_SECONDS = 2 * 60; // x minutes/seconds 
export const RATE_LIMIT_SECONDS = 60; // x seconds between sends per user
...
export const EMPTY_TICK_COUNT = 10; // number of consecutive empty ticks before worker stops
...
// for demonstration of the example lead
